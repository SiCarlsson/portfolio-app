...
const Hero = () => {
  return (
    <SectionWrapper id="hero" className="bg-white flex flex-col justify-between">
      <div className="mt-[25vh] md:mt-[35vh] px-4 md:px-0 md:ml-5">
        <h1 className="text-7xl md:text-9xl font-bold tracking-tight wrap-break-words">Simon Carlsson</h1>
        <h3 className="text-2xl md:text-3xl mt-[1vh] text-gray-500 font-light md:max-w-3xl">Computer Engineering & Economics graduate aspiring to work with data and automation.</h3>
      </div>
